...
export default function App() {
  ...
  return (
    <div style={{ minHeight: "100vh", position: "relative", background: theme.bgDeep, transition: "background 0.4s ease" }}>
      <div style={{ position: "fixed", inset: 0, zIndex: -1, background: theme.appBg, transition: "background 0.4s ease" }} />
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "4px 0 100px" }}>
        ...
        <div style={{ padding: "8px 18px" }}>
          {fbError && (
            <div style={{ textAlign: "center", padding: 30, color: theme.red, fontSize: 13 }}>
              <div style={{ marginBottom: 8 }}>تعذّر الاتصال بقاعدة البيانات.</div>
              {fbErrorMsg && (
                <div style={{ fontSize: 11, color: theme.textMuted, direction: "ltr", wordBreak: "break-word" }}>
                  {fbErrorMsg}
                </div>
              )}
            </div>
            ...
            <div style={{ textAlign: "center", padding: 50 }}>
              <div
                style={{
                  ...
                  borderTopColor: theme.violetLight,
                  borderRadius: "50%",
                  margin: "0 auto",
      ...
      {deleteTarget && (
        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: 15, color: theme.text, marginBottom: 22 }}>هل تريد حذف هذا الدرس؟</p>
            <div style={{ display: "flex", gap: 10 }}>
              <button
                onClick={() => setDeleteTarget(null)}
                style={{ flex: 1, padding: 12, borderRadius: 14, border: `1px solid ${theme.border}`, background: "transparent", color: theme.textMuted, fontFamily: "inherit", cursor: "pointer" }}
              >
                إلغاء
              </button>
              <button
                onClick={confirmDelete}
                style={{ flex: 1, padding: 12, borderRadius: 14, border: "none", background: theme.red, color: "#fff", fontWeight: 700, fontFamily: "inherit", cursor: "pointer" }}
              >
                حذف
              </button>
            </div>
