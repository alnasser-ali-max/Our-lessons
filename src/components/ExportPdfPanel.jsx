  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 style={{ fontFamily: "Amiri, serif", fontSize: 19, color: "var(--violet-light)", marginBottom: 8 }}>
          تصدير دفترنا كاملاً
        </h2>
        <p style={{ fontSize: 13, color: "var(--text-muted)", lineHeight: 1.7, marginBottom: 6 }}>
        ...
        {done && (
          <div style={{ marginTop: 22 }}>
            <p style={{ fontSize: 14, color: "var(--green)", marginBottom: 16 }}>✓ تم إنشاء الملف وتحميله</p>
        ...
        {error && <p style={{ fontSize: 12.5, color: "var(--red)", marginTop: 14 }}>{error}</p>}
      </div>
